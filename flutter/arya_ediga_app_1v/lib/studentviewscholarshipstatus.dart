...
class Viewappliedscholarship extends StatefulWidget {
  const Viewappliedscholarship({Key? key}) : super(key: key);

  @override
  _ViewappliedscholarshipState createState() => _ViewappliedscholarshipState();
}

class _ViewappliedscholarshipState extends State<Viewappliedscholarship> {
  @override
...
class _ViewappliedhostelstatusState extends State<Viewappliedhostelstatus> {
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text("Account No:\t" + widget.shid['account_no']),
                            Text("Scholarship:\t" +
                                widget.shid['scholarshipid']),
                            Text("Status:\t" + widget.shid['status']),
                            getamount(widget.shid['status']),
                          ],
                        ),
                      ),
                    ],
  ...
  getamount(shid) {
    if (shid == "active") {
      return Text("Amount: " + widget.shid['amount']);
    } else if (shid == "blocked") {
      return Text("Reason: " + widget.shid['reason']);
    }
    return Text("");
  }
}
