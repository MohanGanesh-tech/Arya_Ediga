...
class Scholarshippage extends StatefulWidget {
  ...
  const Scholarshippage({Key? key, required this.sid}) : super(key: key);
...
class _ScholarshippageState extends State<Scholarshippage> {
  ...
  FilePickerResult? student_bankpassbook;
  ...
  File? bankpassbookimg;
  String bankpassbookimgcheck = '';
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        border: OutlineInputBorder(),
                        labelText: 'Student Bank Account No*',
                        labelStyle: TextStyle(fontSize: 15)),
                  ),
                ),
                Padding(padding: EdgeInsets.only(top: 10)),
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                try {
                                  ...
                                  if (student_bankpassbook != null) {
                                    PlatformFile file =
                                        student_bankpassbook!.files.first;
                                    print(file.name);
                                    print(file.size);
                                    ...
                                    if (file.extension == 'jpg' ||
                                      ...
                                      setState(() {
                                        bankpassbookimg = null;
                                        bankpassbookimgcheck =
                  ...
                  child: MaterialButton(
                    onPressed: () {
                      ...
                      if (_formKey.currentState!.validate()) {
                        ...
                        context.read<AuthenticationService>().applyscholarship(
                              scholarshipid: widget.sid.trim(),
                              ...
                              account_no: account_no.text.trim(),
                              ...
                              bankpassbook: student_bankpassbook,
                            );
                        Navigator.pop(
                          context,
  ...
  getbankpassbookimgwidget() {
    if (bankpassbookimg != null) {
      ...
      return noimagewidget(bankpassbookimgcheck);
    }
  }
